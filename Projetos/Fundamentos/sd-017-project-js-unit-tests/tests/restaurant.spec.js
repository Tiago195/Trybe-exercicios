...
describe('10 - Implemente os casos de teste e a função `createMenu`', () => {
  it('Verifica se a função `createMenu` tem o comportamento esperado', () => {
    ...
    // ```
    expect(createMenu({ food: { 'coxinha': 3.90, 'sanduiche': 9.90 }, drinks: { 'agua': 3.90, 'cerveja': 6.90 } }).fetchMenu()).toEqual({
      food: { 'coxinha': 3.90, 'sanduiche': 9.90 },
      drinks: { 'agua': 3.90, 'cerveja': 6.90 }
    })
    ...
    // ```
    const teste = createMenu({ food: { 'coxinha': 3.90, 'sanduiche': 9.90 }, drinks: { 'agua': 3.90, 'cerveja': 6.90 } })
    teste.order('coxinha')
    ...
    teste.order('sopa')
    teste.order('sashimi')
    expect(teste.consumption).toEqual(["coxinha", "agua", "sopa", "sashimi"])
    // objetoRetornado.order("coxinha");
    ...
    // ```
    const teste1 = createMenu({ food: { 'coxinha': 3.90, 'sanduiche': 9.90 }, drinks: { 'agua': 3.90, 'cerveja': 6.90 } })
    teste1.order('coxinha');
    teste1.order('agua');
    teste1.order('coxinha');
    expect(teste1.consumption).toEqual(['coxinha', 'agua', 'coxinha'])
    // objetoRetornado.order('coxinha');
    // objetoRetornado.order('agua');
    // objetoRetornado.order('coxinha');

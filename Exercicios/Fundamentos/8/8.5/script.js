...
const myList = [1, 2, 3];
const [ar1, ar2, ar3] = myList
// escreva swap abaixo
// const swap = [...myList].reverse()
const swap = () => [ar3, ar2, ar1]
...
function greet(nome, saudacao = 'Hi') {
